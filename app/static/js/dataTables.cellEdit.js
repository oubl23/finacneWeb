...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html = input.html + "</select>&nbsp;<a href='#/journal' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this);'>Confirm</a> <a href='#/journal' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a> ";
            input.focus = false;
            break;
        ...
        case "datepicker-confirm":
	        ...
	        input.html = "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input> &nbsp;<a href='#/journal' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Confirm</a> <a href='#/journal' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a>";
        ...
        case "text-confirm": // text input w/ confirm
            input.html = "<input id='ejbeatycelledit' class='" + inputCss + "' value='"+oldValue+"'></input>&nbsp;<a href='#/journal' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Confirm</a> <a href='#/journal' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Cancel</a> ";
            break;
